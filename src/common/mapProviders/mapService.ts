...
import { MapServices, MapsProvider } from '../enums/address.enum';
...
export class MapService {
  ...
  private async getMapsProvider(service: string): Promise<MapsProvider> {
    const OLA_SERVICES = {
      [MapServices.DIRECTIONS]: MapsProvider.GOOGLE,
      [MapServices.REVERSE_GEOCODING]: MapsProvider.GOOGLE,
      [MapServices.FORWARD_GEOCODING]: MapsProvider.GOOGLE,
      [MapServices.AUTO_COMPLETE]: MapsProvider.GOOGLE,
    };
